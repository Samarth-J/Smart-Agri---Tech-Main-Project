  ...
  if (googleLogin) {
    googleLogin.addEventListener("click", async function () {
      try {
        ...
        // For Google users, default to main.html (can be enhanced later)
        // In future: check if user exists in MongoDB and get their role
        localStorage.setItem('userRole', 'buyer'); // Default role for Google users
